...
**beads** (command: `bd`) is a Git-backed issue tracker designed for AI-supervised cod
ing workflows. We dogfood our own tool for all task tracking.                         
...
**CRITICAL**: This project uses **bd** for ALL task tracking. Do NOT create markdown T
ODO lists.                                                                            
...
4. **Discover new work?** `bd create "Found bug" -p 1 --deps discovered-from:<parent-i
d> --json`                                                                            
